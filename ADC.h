...
void AudioCodec_Timer2_init(uint16_t samplesSecond);    // set up the sampling Timer2, runs at audio sampling rate in Hz.
...
void AudioCodec_Timer2_init(uint16_t samplesSecond)
{
