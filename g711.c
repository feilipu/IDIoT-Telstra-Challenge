...
/*
  ==========================================================================
   ...
   PROTOTYPE: void alaw_compress(uint32_t lseg, int16_t *linbuf, uint8_t *logbuf)
...
uint8_t          *logbuf;
{
  ...
  for (uint32_t n = 0; n < lseg; ++n)
  {
    ...
    if (linbuf[n] >= 0)  ix |= (0x0080);	/* add sign bit */

    logbuf[n] = (uint8_t)(ix ^ (0x0055));	/* toggle even bits */
  }
}
...
/*
  ==========================================================================
   ...
   PROTOTYPE: void alaw_expand(uint32_t lseg, uint8_t *logbuf, int16_t *linbuf)
...
uint8_t          *logbuf;
{
  ...
  for (uint32_t n = 0; n < lseg; ++n)
  {
    ix = logbuf[n] ^ (0x0055);	/* re-toggle toggled even bits */
...
/*
  ==========================================================================
   ...
   PROTOTYPE: void ulaw_compress(uint32_t lseg, int16_t *linbuf, uint8_t *logbuf)
...
/*
  ==========================================================================
   ...
   PROTOTYPE: void ulaw_expand(uint32_t lseg, uint8_t *logbuf, int16_t *linbuf)
